  ...
  <div class="card">
    ...
    <form action="${pageContext.request.contextPath}/addComplaint" method="post">
      <div class="form-group">
        ...
        <input type="text" name="title" placeholder="e.g., Street light not working" required/>
      </div>

      <div class="form-group">
        <label>Detailed Description</label>
        <textarea name="description" rows="6" placeholder="Provide details about the location and issue..." required></textarea>
      </div>
