...
<body>
<nav class="navbar">
    <a href="#" class="navbar-brand">Civic Connect</a>
    <div class="nav-links">
        <a href="${pageContext.request.contextPath}/jsp/dashboard.jsp">Home</a>
...
<div class="container">
    <div style="margin-bottom: 2rem;">
        ...
        <p style="color: var(--text-muted);">Account Role: <span class="status-badge" style="background:#e2e8f0"><%= user.getRole() %></span></p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
        ...
        <div class="card">
            ...
            <a href="${pageContext.request.contextPath}/myComplaints" class="btn btn-primary" style="background: white; color: var(--primary); border: 1px solid var(--primary);">View My History</a>
        </div>
    </div>
</div>
</body>
